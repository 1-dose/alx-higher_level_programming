...
class TestBase_load_from_file(unittest.TestCase):
	...
	def test_load_from_file_rectangle_types
...
(self):
		...
		Rectangle.save_to_file([r1, r2])
		list_rectangles_output = Rectangle.load_from_file()
		self.assertTrue(isinstance(list_rectangles_output[0], Rectangle))
		self.assertTrue(isinstance(list_rectangles_output[1], Rectangle))
	...
	def test_load_from_file_square_types(self):
		...
		Square.save_to_file([s1, s2])
		list_squares_output = Square.load_from_file()
		self.assertTrue(isinstance(list_squares_output[0], Square))
		self.assertTrue(isinstance(list_squares_output[1], Square))
...
class TestBase_load_from_file_csv(unittest.TestCase):
	...
	def test_load_from_file_csv_empty_list(self):
